...
GAMEDIR=/$directory/ports/infinitydefect/infinitydefect
...
PATH="$godot_dir:$PATH"
GODOT_OPTS="--main-pack infinity-defect.pck"
...
"$runtime" frt.3.5.2  --main-pack "infinity-defect.pck" --fullscreen
